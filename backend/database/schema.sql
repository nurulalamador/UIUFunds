...
DROP TABLE IF EXISTS crowdfunding_spend_items;
DROP TABLE IF EXISTS crowdfunding_donations;
DROP TABLE IF EXISTS crowdfundings;
DROP TABLE IF EXISTS loan_repayments;
DROP TABLE IF EXISTS provided_loans;
DROP TABLE IF EXISTS loan_offers;
DROP TABLE IF EXISTS loans;
DROP TABLE IF EXISTS community_post_comments;
DROP TABLE IF EXISTS community_post_reacts;
...
CREATE TABLE community_posts (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_community_posts_poster FOREIGN KEY (poster_id) REFERENCES users(id) ON DELETE CASCADE,
...
CREATE TABLE community_post_media (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_community_media_post FOREIGN KEY (post_id) REFERENCES community_posts(id) ON DELETE CASCADE,
...
CREATE TABLE community_post_reacts (
    ...
    CONSTRAINT fk_community_reacts_post FOREIGN KEY (post_id) REFERENCES community_posts(id) ON DELETE CASCADE,
    CONSTRAINT fk_community_reacts_user FOREIGN KEY (reactor_id) REFERENCES users(id) ON DELETE CASCADE,
...
CREATE TABLE community_post_comments (
    ...
    CONSTRAINT fk_community_comments_user FOREIGN KEY (commenter_id) REFERENCES users(id) ON DELETE CASCADE,
...
CREATE TABLE loans (
    ...
    status ENUM('open', 'offer_accepted', 'funded', 'completed', 'cancelled') NOT NULL DEFAULT 'open',
    is_completed BOOLEAN NOT NULL DEFAULT FALSE,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_loans_requester FOREIGN KEY (requester_id) REFERENCES users(id) ON DELETE CASCADE,
...
CREATE TABLE loan_offers (
    ...
    CONSTRAINT fk_loan_offers_offeror FOREIGN KEY (offeror_id) REFERENCES users(id) ON DELETE CASCADE,
    CONSTRAINT fk_loan_offers_loan FOREIGN KEY (loan_id) REFERENCES loans(id) ON DELETE CASCADE,
...
CREATE TABLE provided_loans (
    ...
    CONSTRAINT fk_provided_loans_loan FOREIGN KEY (loan_id) REFERENCES loans(id),
    CONSTRAINT fk_provided_loans_offer FOREIGN KEY (loan_offer_id) REFERENCES loan_offers(id),
    CONSTRAINT fk_provided_loans_provider FOREIGN KEY (provider_id) REFERENCES users(id),
    CONSTRAINT fk_provided_loans_borrower FOREIGN KEY (borrower_id) REFERENCES users(id),
...
CREATE TABLE loan_repayments (
    ...
    CONSTRAINT fk_repayment_loan FOREIGN KEY (provided_loan_id) REFERENCES provided_loans(id) ON DELETE CASCADE,
    CONSTRAINT fk_repayment_payer FOREIGN KEY (payer_id) REFERENCES users(id),
    CONSTRAINT fk_repayment_receiver FOREIGN KEY (receiver_id) REFERENCES users(id),
...
CREATE TABLE crowdfundings (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_crowdfundings_user FOREIGN KEY (posted_by) REFERENCES users(id),
...
CREATE TABLE crowdfunding_donations (
    ...
    CONSTRAINT fk_donation_crowdfunding FOREIGN KEY (crowdfunding_id) REFERENCES crowdfundings(id) ON DELETE CASCADE,
...
CREATE TABLE crowdfunding_spend_items (
    ...
    proof_type ENUM('image', 'pdf', 'receipt', 'other') NULL,
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_crowdfunding_spend FOREIGN KEY (crowdfunding_id) REFERENCES crowdfundings(id) ON DELETE CASCADE,
...
CREATE TABLE transactions (
    ...
    transaction_type ENUM(
        'deposit', 'withdrawal', 'loan_given', 'loan_received',
        'loan_repayment_sent', 'loan_repayment_received',
        'crowdfunding_donation', 'crowdfunding_received', 'refund', 'adjustment'
    ) NOT NULL,
    direction ENUM('credit', 'debit') NOT NULL,
    transacted_to BIGINT UNSIGNED NULL,
    transacted_from BIGINT UNSIGNED NULL,
    reference_type ENUM('loan', 'loan_offer', 'provided_loan', 'loan_repayment', 'crowdfunding', 'crowdfunding_donation', 'other') NULL,
    reference_id BIGINT UNSIGNED NULL,
    status ENUM('pending', 'completed', 'failed', 'cancelled') NOT NULL DEFAULT 'completed',
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_transactions_user FOREIGN KEY (user_id) REFERENCES users(id),
    CONSTRAINT fk_transactions_to FOREIGN KEY (transacted_to) REFERENCES users(id),
    CONSTRAINT fk_transactions_from FOREIGN KEY (transacted_from) REFERENCES users(id),
...
CREATE TABLE notifications (
    ...
    notification_type ENUM('general', 'loan_offer', 'loan_offer_accepted', 'loan_repayment', 'crowdfunding', 'community') NOT NULL DEFAULT 'general',
...
-- After registering your own account, make yourself admin with:
-- UPDATE users SET role = 'admin', is_verified = 1 WHERE email = 'your@email.com';
