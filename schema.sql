...
CREATE TABLE community_posts (
    ...
    -- community posts চাইলে auto approve করতে পারো
...
CREATE TABLE loans (
    ...
    -- days/months-এর ambiguity avoid করার জন্য months ধরলাম
    duration_months INT UNSIGNED NOT NULL,

    description TEXT NOT NULL,

    -- requester interest-based offer নিতে রাজি কিনা
    interest_allowed BOOLEAN NOT NULL DEFAULT TRUE,

    -- requester কত installment-এ repayment করতে চায়
...
CREATE TABLE loan_offers (
    ...
    -- offeror কত মাসের জন্য loan দিতে চায়
    ...
    -- একজন একই loan-এ একটাই active/basic offer
...
CREATE TABLE transactions (
    ...
    -- related entity track করার জন্য
    reference_type ENUM(
        'loan',
        'loan_offer',
        'provided_loan',
